...
import type { FileData, MediaMap, IFile } from "./index.vue"
...
onMounted(async () => {
  ...
  try {
    ...
    const res = await useApiFetch<IFile>("/products/saveImage", {
      method: "post",
      body: formData,
      signal: controller.signal,
    })

    if (!media.has(key) || !res) return
